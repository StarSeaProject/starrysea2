...
public class ActivityDaoImpl implements IActivityDao {
	...
	@Override
	// 查询所有众筹活动
	public List<Activity> getAllActivityDao(Condition condition, Activity activity) {
		int start = 0;
	...
	@Override
	// 查询所有众筹活动的数量，用于分页
	public int getActivityCountDao(Condition condition, Activity activity) {
		kumaSqlDao.selectMode();
	...
	@Override
	// 添加一个众筹活动
	public int saveActivityDao(Activity activity) {
	...
	@Override
	// 修改一个众筹活动的状态
	public void updateActivityDao(Activity activity) {
	...
	@Override
	public void updateReduceActivityMoneyDao(Activity activity) {
		kumaSqlDao.updateMode();
